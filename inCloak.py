#this teqniq is opposite to the green screening.
# in green scrnin, v remov bg but here v ll remv the foreground frame

#so our alog / steps r as follows:
#1 capture & store the bg frame.{takes time}
#2 detect the red colored cloth using color detection and sagmentation alog.
#3 segment out the redcolored cloth by generating a mask[used in code]
#4 generate the final augmented output to create a magical effect[video.mp4]


import cv2
import time
#to create array for red cloth numpy
import numpy as np
